    ...
    return (
      <div className="wrapper">
        ...
        <div className="main-panel" >
          <Header headername='My Course' onLogoutClick={this.props.onLogoutClick}></Header>
          <div className="thumbnails">
            {this.props.courses.length ? this.props.courses.map((course, index) =>
              <Course key={index} hrefLink={hrefLink} course={course} imageLink={imageLink} index={index} onCourseClick={this.props.onCourseClick}></Course>)
